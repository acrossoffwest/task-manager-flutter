                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Container(
                            child: _button("SignIn", Colors.white, primary,
                    ...
                    child: Column(children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: _input(Icon(Icons.account_circle),
                            "User name", _nameController, false),
                      ),
                      Padding(
                        padding: EdgeInsets.only(
                          bottom: 20,
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            ...
                            bottom: MediaQuery.of(context).viewInsets.bottom),
                        child: Container(
                          child: _button("SignUp", Colors.white, primary,
    ...
    return Scaffold(
        ...
        body: Column(
          children: <Widget>[
            ...
            Padding(
              child: Container(
                child: _button("SignIn", primary, Colors.white, Colors.white,
                    primary, _loginSheet),
                height: 50,
              ),
